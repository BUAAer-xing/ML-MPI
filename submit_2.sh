#!/bin/bash
#SBATCH -J mpi-ml-computation_815-1628
#SBATCH -p xahcnormal
#SBATCH -N 2
...
do
    ...
    do
        ...
        mpirun -hosts=$SLURM_NODELIST -n $x python mpi-ml.py $id log_2.txt time_2.csv
